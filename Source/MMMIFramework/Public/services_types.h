...
class MMIFRAMEWORK_API MIKServiceResult : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MWalkPoint : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MIKProperty : public virtual ::apache::thrift::TBase {
 public:

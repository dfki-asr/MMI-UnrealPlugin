...
class MMIFRAMEWORK_API MVector3 : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MVector2 : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MQuaternion : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MVector : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MTransform : public virtual ::apache::thrift::TBase {
 public:

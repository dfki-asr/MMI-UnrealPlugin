...
class MMIFRAMEWORK_API MSimulationState : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MSimulationResult : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MSimulationEvent : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MVersion : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MDependency : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MMUDescription : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MInstruction : public virtual ::apache::thrift::TBase {
 public:

...
class MMIFRAMEWORK_API MIPAddress : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MBoolResponse : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MParameter : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MExecutableDescription : public virtual ::apache::thrift::TBase {
 public:
...
class MMIFRAMEWORK_API MServiceDescription : public virtual ::apache::thrift::TBase {
 public:
